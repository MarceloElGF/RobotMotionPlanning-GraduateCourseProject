...
class E160_environment:
    ...
    def __init__(self, deltaT = 0.1):
        ...
        for i in range (0,self.num_robots):
            ...
            #r = E160_robot(self, '\x00\x0C', i, deltaT, vehicle = "d") ##### commented out according to webpage

            # if the robots are "4-wheel driven"
            r = E160_robot(self, '\x00\x0C', i, deltaT, vehicle = "v") ##### added according to webpage
